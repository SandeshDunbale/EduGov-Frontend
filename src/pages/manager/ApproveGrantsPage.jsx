...
const ApproveGrantsPage = () => {
  ...
  const fetchPendingGrants = async () => {
    setLoading(true);
    try {
      const data = await grantService.getPendingApplications();
  ...
  const handleDecision = async (applicationId, decision) => {
    ...
    try {
      ...
      const response = await grantService.decideGrantApplication(applicationId, managerUserId, decision);
      ...
      setPendingGrants(prev => prev.filter(app => app.applicationID !== applicationId));
                    ...
                    <tr key={app.applicationID}>
                      ...
                      <td className="pe-4 py-3">
                        <div className="d-flex justify-content-center gap-2">
                          <button 
                            onClick={() => handleDecision(app.applicationID, 'APPROVED')}
